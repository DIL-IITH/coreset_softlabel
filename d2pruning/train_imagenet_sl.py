...
file=open('d2_pruning_results_ilsvrc_sl.txt','a+')
file.writelines("coreset mode: {}, temp: {}, Coreset ratio={},best acc={}".format(args.coreset_mode,args.temperature,coreset_ratio,best_acc))
file.writelines("\n")
file.close()
