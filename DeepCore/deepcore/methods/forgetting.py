...
class Forgetting(EarlyTrain):
    ...
    def after_loss(self, outputs, loss, targets, batch_inds, epoch):
        with torch.no_grad():
            ...
            self.forgetting_events[torch.tensor(batch_inds,device=self.args.device)[(self.last_acc[batch_inds]-cur_acc)>0.01]]+=1.
    ...
    def select(self, **kwargs):
        ...
        print(self.forgetting_events.shape)
        torch.save(self.forgetting_events,"metrics/forgetting_events.pt")
