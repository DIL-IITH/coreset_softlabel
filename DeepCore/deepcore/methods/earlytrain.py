...
class EarlyTrain(CoresetMethod):
    ...
    def run(self):
        ...
        checkpoint_path = 'pretrained/checkpoint_{}.pth'.format(self.args.dataset)
        if not os.path.exists(checkpoint_path):
            print("[INFO] checkpoint {} does not exist. Proceeding with training.".format(checkpoint_path))
            self.before_run()
            ...
            print("[INFO] checkpoint {} exists.".format(checkpoint_path))
